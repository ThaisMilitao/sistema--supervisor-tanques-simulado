...
SupTanquesImg::SupTanquesImg(QWidget *parent)
  : QLabel(parent)
  , displayLevel(true)
  , V1Open(false)
  , V2Open(false)
...
void SupTanquesImg::setDisplayMode(bool show_level)
{
...
void SupTanquesImg::addPoint(int T, const SupState& S)
{
  V1Open = (S.V1 != 0);
  V2Open = (S.V2 != 0);
  overflow = (S.ovfl != 0);
...
void SupTanquesImg::resizeEvent(QResizeEvent* event)
{
